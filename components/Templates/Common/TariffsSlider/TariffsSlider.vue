				...
				>
					<div class="tariffs-slider__item">
						...
						<ul class="tariffs-slider__advantages">
							<li
								class="tariffs-slider__advantage"
								v-for="advantage in slide.advantages"
							>
								{{ advantage.text }}
							</li>
						</ul>
						<div class="tariffs-slider__price tariffs-slider__price_day">
							<div class="tariffs-slider__values">
								<div
									class="tariffs-slider__value tariffs-slider__value_new"
									:class="[null, 0].includes(setDayPrice(slide).new) ? 'tariffs-slider__value_free' : ''"
								>
									{{ setDayPrice(slide).new }} руб
								</div>
								<div
									class="tariffs-slider__value tariffs-slider__value_old"
									v-show="setDayPrice(slide).old && setDayPrice(slide).old != 0"
								>
									{{ setDayPrice(slide).old }} руб
								</div>
							</div>
							<div
								class="tariffs-slider__discount"
								:class="!slide.discount_text ? 'tariffs-slider__discount_none' : ''"
							>
